...
namespace LupyAPI.Controllers
{
    ...
    public class PetController : Controller<IPetService, Pet, PetDTO>
    {
        public PetController(IPetService controllerService, IMapper mapper) : base(controllerService, mapper)
        {
        }
    }
}